...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => HendrikKurniawanGintingDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Hendrik Kurniawan Ginting (6SIA6)'),
        ),
        body: LoginPage(),
      ),
    );
...
class HendrikKurniawanGintingDataTable extends StatefulWidget {
  _HendrikKurniawanGintingDataTableState createState() => _HendrikKurniawanGintingDataTableState();
}

class _HendrikKurniawanGintingDataTableState extends State<HendrikKurniawanGintingDataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hendrik Kurniawan Ginting - 6SIA6'),
      ),
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Hendrik Kurniawan Ginting", ),
      DataMahasiswa(
